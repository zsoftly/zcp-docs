...
const frSidebarLabels = {
  ...
  'Debian Availability': 'Disponibilité de Debian',
          ...
          items: [
            ...
            },
            {
              ...
              items: [
                ...
                { label: 'Debian Availability', slug: 'public-cloud/operating-systems/debian' },
            ...
            },
            {
              ...
              collapsed: true,
              items: [
                { label: 'Overview', slug: 'public-cloud/dns/overview' },
                { label: 'Domains', slug: 'public-cloud/dns/domains' },
                {
                  label: 'Records',
                  collapsed: true,
                  items: [
                    { label: 'Overview', slug: 'public-cloud/dns/records' },
                    { label: 'A and AAAA', slug: 'public-cloud/dns/records/a-aaaa' },
                    { label: 'CNAME', slug: 'public-cloud/dns/records/cname' },
                    { label: 'MX', slug: 'public-cloud/dns/records/mx' },
                    { label: 'TXT', slug: 'public-cloud/dns/records/txt' },
                    { label: 'CAA', slug: 'public-cloud/dns/records/caa' },
                    { label: 'NS', slug: 'public-cloud/dns/records/ns' },
                  ],
                },
                { label: 'CLI', slug: 'public-cloud/dns/cli' },
                { label: 'API', slug: 'public-cloud/dns/api' },
                { label: 'Examples', slug: 'public-cloud/dns/examples' },
                { label: 'Troubleshooting', slug: 'public-cloud/dns/troubleshooting' },
              ],
            },
            {
              label: 'Marketplace',
