...
Changer le système d'exploitation efface toutes les données et configurations existantes sur la VM.
Sauvegardez les données critiques avant de continuer. Supprimez les instantanés et les sauvegardes
avant de changer le système d'exploitation.

:::

- Allez à **VM Settings** → **Change OS**.
