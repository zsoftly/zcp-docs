...
![Page Réseaux sur l'onglet Réseau public avec le bouton d'ajout (+)](../../../../../../assets/networking/create-create-a-public-network.webp)

### Choisir un emplacement

Sélectionnez l'emplacement du centre de données où héberger le réseau.

![Créer un réseau public : choisir un emplacement](../../../../../../assets/networking/create-choose-a-location.webp)

### Assigner à un projet

Assignez le réseau à un projet pour organiser les ressources.

![Créer un réseau public : assigner à un projet](../../../../../../assets/networking/create-assign-to-a-project.webp)
...
![Créer un réseau public : configuration de la passerelle et du masque réseau](../../../../../../assets/networking/create-network-configurations.webp)

### Nom

Fournissez un nom unique pour votre réseau public.

![Créer un réseau public : nommer le réseau](../../../../../../assets/networking/create-name.webp)
