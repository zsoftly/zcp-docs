...
IceWarp conserve des données avec état. Les boîtes aux lettres, calendriers, fichiers téléversés,
données MariaDB, données Redis, journaux, caches, configuration et état de collaboration peuvent
...
### 4. Ouvrir IceWarp de manière sécurisée
...
Ne soumettez pas d'identifiants administrateur à une URL HTTP publique. Pour un accès public direct,
...
L'utilisation d'IceWarp pour le courrier et la collaboration en production exige une planification
DNS:
