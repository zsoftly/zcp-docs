...
l'accès au bureau à distance. Vous pouvez vous connecter avec un client Remote Desktop Protocol
...
Au premier démarrage, le service applique les métadonnées de la plateforme, régénère les clés hôte
SSH, crée ou met à jour l'utilisateur de bureau, configure KDE Plasma comme session XRDP et démarre
XRDP.
...
Le fichier est lisible uniquement par l'utilisateur root.
